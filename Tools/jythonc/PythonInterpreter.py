...
class FlowControlException(Exception): pass
class DoBreak(FlowControlException): pass
class DoContinue(FlowControlException): pass
class DoReturn(FlowControlException): pass
...
class PyInteger(PyObject): pass
class PyFloat(PyObject): pass
class PyString(PyObject): pass
...
true = PyObject(1); false = PyObject(0)
