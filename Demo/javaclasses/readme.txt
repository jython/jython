...
Note: path names are given for a Unix machine.  Make the obvious translation for Windows.
...
2. run "jpythonc -package pygraph Graph.py" in this directory
    This should produce the Java class pygraph.Graph.  Because this is only
    ...
    setExpression methods.  These cause convenient methods to be created on
