    ...
    public PyObject __findattr__(String name) {
        ...
        try {
            if (getattribute != null) {
                return getattribute.__get__(this, self_type).__call__(
                        py_name = new PyString(name));
            } else {
            ...
            if (Py.matchException(e, Py.AttributeError)) {
                ...
                if (getattr != null)
                    try {
                        return getattr.__get__(this, self_type).__call__(
                                py_name != null ? py_name : new PyString(name));
