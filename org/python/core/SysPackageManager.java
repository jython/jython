...
protected void message(String msg) { Py.writeMessage("*sys-package-mgr*",msg); }
protected void warning(String warn) { Py.writeWarning("*sys-package-mgr*",warn); }
protected void comment(String msg) { Py.writeComment("*sys-package-mgr*",msg); }
protected void debug(String msg) {Py.writeDebug("*sys-package-mgr*",msg); }
    ...
    public PyList doDir(PyJavaPackage jpkg,boolean instantiate,boolean exclpkgs) {
        ...
        if (system.getClassLoader() == null) doDir(system.path,ret,jpkg,instantiate,exclpkgs);
