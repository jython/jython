...
class MakeProxies {
	...
	public static synchronized Class makeProxy(Class c, Vector vinterfaces, String name, PyObject dict) {
	    ...
	    org.python.compiler.JavaMaker jm = new org.python.compiler.JavaMaker(c, interfaces, name, "foo", proxyName, dict);
	    try {
	        jm.build();
	        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
