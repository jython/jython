...
class PyIntegerConstant extends Constant {
	...
	public void get(Code c) throws IOException {
		c.getstatic(module.classfile.name, name, "Lorg/python/core/PyInteger;");
	}

	public void put(Code c) throws IOException {
		module.classfile.addField(name, "Lorg/python/core/PyInteger;", access);
		c.iconst(value);
		int mref_newInteger = c.pool.Methodref("org/python/core/Py", "newInteger", "(I)Lorg/python/core/PyInteger;");
		c.invokestatic(mref_newInteger);
		c.putstatic(module.classfile.name, name, "Lorg/python/core/PyInteger;");
	}
	...
	public boolean equals(Object o) {
		if (o instanceof PyIntegerConstant) return ((PyIntegerConstant)o).value == value;
		else return false;
	}
}
...
class PyFloatConstant extends Constant {
	...
	public void put(Code c) throws IOException {
		...
		int mref_newFloat = c.pool.Methodref("org/python/core/Py", "newFloat", "(D)Lorg/python/core/PyFloat;");
	...
	public boolean equals(Object o) {
		if (o instanceof PyFloatConstant) return ((PyFloatConstant)o).value == value;
		else return false;
	}
}
class PyComplexConstant extends Constant {
	...
	public void get(Code c) throws IOException {
		c.getstatic(module.classfile.name, name, "Lorg/python/core/PyComplex;");
	}

	public void put(Code c) throws IOException {
		module.classfile.addField(name, "Lorg/python/core/PyComplex;", access);
		c.ldc(c.pool.Double(value));
		int mref_newImaginary = c.pool.Methodref("org/python/core/Py", "newImaginary", "(D)Lorg/python/core/PyComplex;");
		c.invokestatic(mref_newImaginary);
		c.putstatic(module.classfile.name, name, "Lorg/python/core/PyComplex;");
	}
	...
	public boolean equals(Object o) {
		if (o instanceof PyComplexConstant) return ((PyComplexConstant)o).value == value;
		else return false;
	}
}
class PyStringConstant extends Constant {
	...
	public void put(Code c) throws IOException {
		...
		c.ldc(value);
		int mref_newString = c.pool.Methodref("org/python/core/Py", "newString", "(Ljava/lang/String;)Lorg/python/core/PyString;");
	...
	public boolean equals(Object o) {
		if (o instanceof PyStringConstant) return ((PyStringConstant)o).value.equals(value);
		else return false;
	}
}
...
class PyLongConstant extends Constant {
	...
	public void put(Code c) throws IOException {
		...
		c.ldc(value);
		int mref_newLong = c.pool.Methodref("org/python/core/Py", "newLong", "(Ljava/lang/String;)Lorg/python/core/PyLong;");
	...
	public boolean equals(Object o) {
		if (o instanceof PyLongConstant) return ((PyLongConstant)o).value.equals(value);
		else return false;
	}
}
...
public class Module {
	...
	public Module(String name, String filename, boolean linenumbers) {
		...
		sfilename = filename;
		if (filename != null) this.filename = PyString(filename);
	...
	public void addRunnable() throws IOException {
		Code c = classfile.addMethod("getMain", "()Lorg/python/core/PyCode;", ClassFile.PUBLIC);
		mainCode.get(c);
		c.areturn();
	}
	...
	public void addMain() throws IOException {
		...
		int mref_self = c.pool.Fieldref(classfile.name, "self", "L"+classfile.name+";");
		c.getstatic(mref_self);
		c.aload(0);
		c.invokestatic(c.pool.Methodref("org/python/core/Py", "do_main",
	...
	public void addFunctions() throws IOException {
		Code code = classfile.addMethod("call_function", "(ILorg/python/core/PyFrame;)Lorg/python/core/PyObject;", ClassFile.PUBLIC);

		Label def = code.getLabel();
		Label[] labels = new Label[codes.size()];
		int i;
		for(i=0; i<labels.length; i++) labels[i] = code.getLabel();
		...
		for(i=0; i<labels.length; i++) {
			...
			code.aload(0);
			code.aload(2);
			code.invokevirtual(classfile.name, ((PyCodeConstant)codes.elementAt(i)).fname,
				"(Lorg/python/core/PyFrame;)Lorg/python/core/PyObject;");
			code.areturn();
		}
		def.setPosition();
	...
	public static void compile(SimpleNode node, OutputStream ostream,
			...
			boolean linenumbers, boolean printResults, boolean setFile) throws Exception {
