...
public abstract class PySequenceObjectList extends PySequenceList implements List {

    protected PyObjectList list;

    public PySequenceObjectList() {
        list = new PyObjectList();
    }

    protected PySequenceObjectList(PyType type) {
        super(type);
        list = new PyObjectList();
    }

    protected PySequenceObjectList(PyType type, PyObject[] elements) {
        super(type);
     ...
     */
    public PySequenceObjectList(PyObject[] elements) {
        list = new PyObjectList(elements);
    }

    public PySequenceObjectList(PyType type, Collection<PyObject> c) {
        super(type);
    ...
    public boolean equals(Object o) {
        if(o instanceof PySequenceObjectList) {
            return list.equals(((PySequenceObjectList)o).list);
        } else if(o instanceof List) {
            return o.equals(this);
        } else {
            return ((PySequence)this).equals(o);
        }
    }
