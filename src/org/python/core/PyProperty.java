...
public class PyProperty extends PyObject implements PyType.Newstyle {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        dict.__setitem__("fget", new PyGetSetDescr("fget", PyProperty.class,
                "getFget", null));
        dict.__setitem__("fset", new PyGetSetDescr("fset", PyProperty.class,
                "getFset", null));
        dict.__setitem__("fdel", new PyGetSetDescr("fdel", PyProperty.class,
                "getFdel", null));
        dict.__setitem__("__doc__", new PyGetSetDescr("__doc__",
                PyProperty.class, "getDoc", null));
        ...
        dict.__setitem__("__get__", new PyMethodDescr("__get__",
                PyProperty.class, 1, 2, new exposed___get__(null, null)));
        ...
        dict.__setitem__("__set__", new PyMethodDescr("__set__",
                PyProperty.class, 2, 2, new exposed___set__(null, null)));
        ...
        dict.__setitem__("__delete__", new PyMethodDescr("__delete__",
                PyProperty.class, 1, 1, new exposed___delete__(null, null)));
        ...
        dict.__setitem__("__init__", new PyMethodDescr("__init__",
                PyProperty.class, -1, -1, new exposed___init__(null, null)));
        dict.__setitem__("__new__", new PyNewWrapper(PyProperty.class,
                "__new__", -1, -1) {
            ...
            public PyObject new_impl(boolean init, PyType subtype,
                ...
                if (for_type == subtype) {
                    ...
                    newobj = null; // new PyPropertyDerived(subtype);
                }
                return newobj;
            }
