...
// should be able to use ScopesCompiler pretty much *as is*

// needs to construct a PyBytecode object, include
// co_code, co_const, co_cellvars, co_freevars, co_stacksize (use something like compile.opcode_stack_effect)
// etc.
...
//
    public BytecodeCompiler(Module module, boolean print_results) {
//        this.module = module;
